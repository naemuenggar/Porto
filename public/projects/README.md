...
Save project screenshots here. They are served by Vite at the root path, e.g.
`public/projects/ecommerce.png` is referenced in code as `/projects/ecommerce.png`.
